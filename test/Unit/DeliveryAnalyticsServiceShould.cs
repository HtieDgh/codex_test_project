...
namespace test.Unit
{
    public class DeliveryAnalyticsServiceShould
    {
        ...
        public static IEnumerable<object[]> GetValidTestData()
        {
            ...
            yield return new object[] {//Набор 4 (ограничение по дате сверху)
                data,
                new DateOnly(2022, 1, 6), //startDate, 
                DateOnly.MaxValue, //endDate,  
                3.6//expectedOutput
            };
        }
        ...
        public void ReturnCorrectOnValid(List<Sale> data, DateOnly startDate, DateOnly endDate, double expectedOutput)
        {
            ...
            var actualOutput = 0.0;//Действительно

            var mockWriter = new Mock<IWriter>();
            mockWriter.Setup(w => w.AddReport(It.IsAny<DeliveryAnalyticsService.Report>()))
                .Callback<DeliveryAnalyticsService.Report>(report => actualOutput = report.avgTime);//Полученный avgTime поместить в actualOutput


            var service = new DeliveryAnalyticsService(mockWriter.Object, mockSalesParser.Object, IAnalyticsService.MODE.SYNCRONOUS, startDate, endDate);
        ...
        public async Task ReturnCorrectOnValid_Async()
        {
            ...
            double actualOutput = 0.0;//Для получения вывода
            var expectedOutput = 5.0;


            var mockWriter = new Mock<IWriter>();
            mockWriter.Setup(w => w.AddReport(It.IsAny<DeliveryAnalyticsService.Report>()))
                .Callback<DeliveryAnalyticsService.Report>(report => actualOutput = report.avgTime);//Полученный Report добавлять в actualOutput

            var service = new DeliveryAnalyticsService(mockWriter.Object, mockSalesParser.Object, IAnalyticsService.MODE.SYNCRONOUS, DateOnly.MinValue, DateOnly.MaxValue);
        ...
        public void BuildYourself_WithHelper()
        {
            ...
            var service = new DeliveryAnalyticsService.Builder()
        ...
        public async Task RunAsyncTruly()
        {
            ...
            var service = new DeliveryAnalyticsService(mockWriter.Object, mockParser.Object, IAnalyticsService.MODE.SYNCRONOUS, DateOnly.MinValue, DateOnly.MaxValue);
